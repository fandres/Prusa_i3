...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // set to true to invert the logic of the probe.  // Sensor Inductivo	
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 5  // Example:10   // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER  37  // Example:10   // Y offset: -front +behind [the nozzle]
...
// #define MIN_SOFTWARE_ENDSTOPS  // Ojo
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION 80 // 37 , y =0 OFFSET_FROM_EXTRUDER
  ...
  #define UBL_MESH_EDIT_MOVES_Z     // Sophisticated users prefer no movement of nozzle  // test
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 160  //180
#define PREHEAT_1_TEMP_BED     68  //70
